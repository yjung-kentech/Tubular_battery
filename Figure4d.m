...
% Cylindrical cell
plot(0, rho_app_cyl_results(:, 1), 'Color', color1, 'Marker', 's', 'MarkerFaceColor', color1, 'LineWidth', 1, 'LineStyle', 'none');
plot(0, rho_app_cyl_results(:, 2), 'Color', color2, 'Marker', 's', 'MarkerFaceColor', color2, 'LineWidth', 1, 'LineStyle', 'none');
plot(0, rho_app_cyl_results(:, 3), 'Color', color3, 'Marker', 's', 'MarkerFaceColor', color3, 'LineWidth', 1, 'LineStyle', 'none');

legend({'', '', ''}); 

yyaxis right;
plot(0, desired_points(1).t95, 'Color', color1, 'Marker', 'o', 'MarkerFaceColor', color1, 'LineWidth', 1, 'LineStyle', 'none');
plot(0, desired_points(2).t95, 'Color', color2, 'Marker', 'o', 'MarkerFaceColor', color2, 'LineWidth', 1, 'LineStyle', 'none');
plot(0, desired_points(3).t95, 'Color', color3, 'Marker', 'o', 'MarkerFaceColor', color3, 'LineWidth', 1, 'LineStyle', 'none');
...
for i = 1:length(R_out_values)
    ...
    plot(R_in_values * 2, rho_app_results(:, i), 'Color', colors(mod(i - 1, size(colors, 1)) + 1, :), 'LineStyle', '-', 'Marker', 's', ...
...
exportgraphics(gcf, 'figure4d_1230.png', 'Resolution', 300);
