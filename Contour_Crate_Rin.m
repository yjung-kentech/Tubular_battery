...
data_file = fullfile(data_dir, 'Tubular_Sweep_Crate_Rin_60.mat');
load(data_file);
...
contourf(D_in_vec, C_rate_vec, data.t95, linspace(cmin, cmax, numContours), 'LineColor', 'none');
clim([cmin cmax]);
hold on;
...
titleHandle = title('Charging Time [min] (D_{out} = 60 mm)'); % 46, 60, 80
...
exportgraphics(gcf, 'Tubular_contour_time_Din_60.png', 'Resolution', 300);