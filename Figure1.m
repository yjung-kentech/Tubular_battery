...
plot(time1, T_max1, 'red', 'LineWidth', 1, 'DisplayName', 'Tube T_{max}');
hold on
plot(time1, T_avg1, 'red--', 'LineWidth', 1, 'DisplayName', 'Tube T_{avg}');
hold on
plot(time2, T_max2, 'blue', 'LineWidth', 1, 'DisplayName', 'Cylinder T_{max}');
hold on
plot(time2, T_avg2, 'blue--', 'LineWidth', 1, 'DisplayName', 'Cylinder T_{avg}');
hold off
